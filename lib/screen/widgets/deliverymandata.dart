...
class deliverymandata extends StatefulWidget {
  const deliverymandata({Key? key}) : super(key: key);

  @override
  State<deliverymandata> createState() => _deliverymandataState();
}

class _deliverymandataState extends State<deliverymandata> {
